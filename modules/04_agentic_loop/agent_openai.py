"""
Module 04 — Agentic Loop (GitHub Models / OpenAI variant)
=========================================================
...
Run:
    python modules/04_agentic_loop/agent_openai.py
    python modules/04_agentic_loop/agent_openai.py "Which customers have never ordered?"
    python modules/04_agentic_loop/agent_openai.py --repl
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Agentic loop demo (GitHub Models)")
